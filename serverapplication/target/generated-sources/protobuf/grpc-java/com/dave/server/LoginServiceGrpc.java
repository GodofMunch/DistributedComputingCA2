...
public final class LoginServiceGrpc {
  ...
  public static final String SERVICE_NAME = "com.dave.server.LoginService";

  // Static method descriptors that strictly reflect the proto.
  @io.grpc.ExperimentalApi("https://github.com/grpc/grpc-java/issues/1901")
  public static final io.grpc.MethodDescriptor<com.dave.server.LoginServiceOuterClass.LoginRequest,
      com.dave.server.LoginServiceOuterClass.LoginResponse> METHOD_LOGIN =
      io.grpc.MethodDescriptor.<com.dave.server.LoginServiceOuterClass.LoginRequest, com.dave.server.LoginServiceOuterClass.LoginResponse>newBuilder()
          .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
          .setFullMethodName(generateFullMethodName(
              "com.dave.server.LoginService", "login"))
          .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
              com.dave.server.LoginServiceOuterClass.LoginRequest.getDefaultInstance()))
          .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
              com.dave.server.LoginServiceOuterClass.LoginResponse.getDefaultInstance()))
  ...
  public static abstract class LoginServiceImplBase implements io.grpc.BindableService {
    ...
    /**
     */
    public void login(com.dave.server.LoginServiceOuterClass.LoginRequest request,
        io.grpc.stub.StreamObserver<com.dave.server.LoginServiceOuterClass.LoginResponse> responseObserver) {
    ...
    @java.lang.Override public final io.grpc.ServerServiceDefinition bindService() {
      return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
          .addMethod(
            ...
            asyncUnaryCall(
              new MethodHandlers<
                com.dave.server.LoginServiceOuterClass.LoginRequest,
                com.dave.server.LoginServiceOuterClass.LoginResponse>(
                  this, METHODID_LOGIN)))
          .build();
    }
  }
  ...
  public static final class LoginServiceBlockingStub extends io.grpc.stub.AbstractStub<LoginServiceBlockingStub> {
    ...
    /**
     */
    public com.dave.server.LoginServiceOuterClass.LoginResponse login(com.dave.server.LoginServiceOuterClass.LoginRequest request) {
  ...
  public static final class LoginServiceFutureStub extends io.grpc.stub.AbstractStub<LoginServiceFutureStub> {
    ...
    /**
     */
    public com.google.common.util.concurrent.ListenableFuture<com.dave.server.LoginServiceOuterClass.LoginResponse> login(
        com.dave.server.LoginServiceOuterClass.LoginRequest request) {
  ...
  private static final class MethodHandlers<Req, Resp> implements
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_LOGIN:
          serviceImpl.login((com.dave.server.LoginServiceOuterClass.LoginRequest) request,
              (io.grpc.stub.StreamObserver<com.dave.server.LoginServiceOuterClass.LoginResponse>) responseObserver);
          break;
        default:
  ...
  private static abstract class LoginServiceBaseDescriptorSupplier
    ...
    public com.google.protobuf.Descriptors.FileDescriptor getFileDescriptor() {
      return com.dave.server.LoginServiceOuterClass.getDescriptor();
    }
